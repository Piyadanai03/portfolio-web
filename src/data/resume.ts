...
export const mockExperiences: Experience[] = [
  {
    ...
    endDate: null,
    description: "ให้บริการพัฒนาเว็บไซต์และออกแบบระบบซอฟต์แวร์ตามความต้องการของลูกค้า ไม่ว่าจะเป็นการสร้างเว็บไซต์ตั้งแต่ต้น การปรับปรุงระบบที่มีอยู่แล้ว รวมถึงนำ AI มาใช้กับระบบ Linebot n8n รวมถึงเว็ปไซต์อื่นๆ ด้วย และเคยดูแล wordpress อยู๋ช่วงหนึ่งด้วย ส่วน Stack ขึ้นอยู่กับความต้องการของผู้ว่าจ้าง หรือแนะนำเทคโนโลยีที่เหมาะสมกับโปรเจกต์นั้นๆ เช่น React, Node.js, Python, PHP และอื่นๆ ตามความเหมาะสม"
  },
  {
    id: "exp-02",
    userID: USER_ID,
